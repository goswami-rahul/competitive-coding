/*
Problem required to find the shortest xor sum path from node 1 to n,
in a connected graph with self loops and multiple edges.
First, store the xors of all the simple cycles of the graph in a vector
Let xor of some path from 1 to n be P
Problem reduces to choosing S to minimize P xor S
such that S can be formed using xors on the set of xors of cycles.
This is solvable by Gaussian elimination on modulo 2.
*/
#include<bits/stdc++.h>
