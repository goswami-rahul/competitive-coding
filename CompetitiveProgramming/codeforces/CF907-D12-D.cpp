/*
Constructive problem, with a lot of corner cases
if one side is >= 2 and other is >= 4, answer exists
rotate every 2nd row two cells to the right (or left)
then rotate every 2 nd column to up (or down).
*/
#include<bits/stdc++.h>
