/*
Used bitmask DP with DP[i][mask]
i indicates we have calculated answer upto ith element.
mask contains the prime factors of the number to be used (can be atmost 17)
so memory used is ~O(100 * (2^17))
*/
#include<bits/stdc++.h>
