/*
create sparse tables for or and maximum for the array.
then for each element, considerind it as the maximum in some range,
find the left and right bounds of such range.
now in this range, find the range outside which, the or of the elements
become greater than this. add the number of such ranges to the answer.
*/
#include<bits/stdc++.h>
using namespace std;
