/*
Problem reduces to calculating sum of maxima of all paths of the tree (and minima)
for maxima, sort the vertices in non-decreasing order, and process them one by one
maintaining "active" vertices, those which have been processed.
for each processing, connect the vertex to the neighbours which are active, and
count the paths in it.
similarly for the maxima
then, subtract the minima from the maxima sum.
*/
#include<bits/stdc++.h>
using namespace std;
