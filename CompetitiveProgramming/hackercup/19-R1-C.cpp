/**
 * Create a flow network with source at h = 0, sink at h = H.
 * The edges have weights equal to the length of ranges overlapped 
 * minus the part of the overlapped length blocked by some
 * ladders in between.
 * The answer is the Min-Cut of the flow network. 
**/
#include <bits/stdc++.h>
using namespace std;
