...
int main()
{
    ...
    while (tt--) {
        ...
        if (4 * d > d * d) {
            ...
            cout << fixed << setprecision(9) << "Y " << (double) d / 2.0 << ' ' <<  (double) d / 2.0 << el;
            continue;
        } else {
            long double s = sqrt((long double) (d * d - 4 * d));
            cout << fixed << setprecision(9) << "Y " << ((long double) d + s) / 2.0 << ' ' << ((long double) d - s) / 2.0 << el;
        }
